...
function Footer() {
  return (
    <footer className="w-[var(--footerWidth)] m-auto  mb-32  p-6 sm:p-0 transition-transform duration-500 sm:w-[70vw] ">
      <div className="footer-container w-full  m-auto">
        <div className="flex flex-col gap-4">
          <div className=" bg-primary   border border-accent p-6 rounded-lg  footer-nav-container flex justify-between sm:grid sm:grid-cols-5 ">
            <div>
              <ul className="footer-right-ul">
                <li>
                  <a href="https://flowbite.com/" className="footer-a">
                    Dice
                  </a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" className="footer-a">
                    Provably Fair
                  </a>
                </li>
                <li>
          ...
          <div className="footer-left-container flex flex-col items-center gap-1 lg:mb-0">
            <a href="/" className="flex items-center">
              <span className="footer-text-title tracking-wide text-2xl">
                Gambloors
              </span>
            </a>
            <p className="text-base mb-6 text-primaryWhite">
              Online Crypto Casino
            </p>
            <div className="flex  w-full sm:w-auto sm:gap-8  justify-between sm:justify-normal">
